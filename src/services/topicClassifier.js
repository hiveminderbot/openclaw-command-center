...
const STOP_WORDS = new Set([
  ...
  "theirs", "what", "which", "who", "whom", "this", "that", "these", "those", "am", "is",
  "are", "was", "were", "be", "been", "being", "have", "has", "had", "having", "do", "does",
  "did", "doing", "would", "could", "ought", "let", "like", "need", "want", "got", "get",
  "make", "made", "see", "look", "think", "know", "take", "come", "go", "say", "said",
  "tell", "told", "ask", "use", "used", "find", "give", "gave", "yes", "no", "ok", "okay",
  "yeah", "sure", "right", "well", "also", "really", "actually", "basically", "probably",
  "maybe", "file", "code", "run", "check", "help", "please", "thanks", "hello", "hi", "hey",
...
function loadDiscoveredTopics() {
  ...
  return { version: 1, topics: {}, lastUpdated: null };
}

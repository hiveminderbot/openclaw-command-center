 ...
 * Jobs Service
 *
 * Business logic for job management and operations.
...
async function getSchedulerStatus() {
  ...
  if (!api) throw new Error("Jobs API not available");
...
/**
 * List all jobs with enhanced relative times
 */
 ...
 * Pause a job
 */
async function pauseJob(jobId, options = {}) {
  const api = await getAPI();
  if (!api) throw new Error("Jobs API not available");
  return api.pauseJob(jobId, options);
}
...
// ============================================================================
// HTTP Request Handlers (for backward compatibility with tests)
// ============================================================================
